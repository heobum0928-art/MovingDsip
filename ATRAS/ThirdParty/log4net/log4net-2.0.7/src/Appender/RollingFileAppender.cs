...
namespace log4net.Appender
{
    ...
    protected bool IfRollOverDate(DateTime n)
    {
      return n >= m_nextCheck;
    }

    protected bool IfRollOverSize()
    {
      return (File != null) && ((CountingQuietTextWriter)QuietWriter).Count >= m_maxFileSize;
    }
    ...
    protected bool IfDeleteLastFile()
    {
      return m_curSizeRollBackups == m_maxSizeRollBackups;
    }
