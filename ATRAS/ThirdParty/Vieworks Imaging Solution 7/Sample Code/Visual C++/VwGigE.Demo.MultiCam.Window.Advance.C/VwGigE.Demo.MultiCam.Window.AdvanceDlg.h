...
class CVwGigEDemoMultiCamWindowAdvanceDlgC : public CDialog
{

public:
	CVwGigEDemoMultiCamWindowAdvanceDlgC(CWnd* pParent = NULL);
	~CVwGigEDemoMultiCamWindowAdvanceDlgC();
...
public:
	...
	void SetUIResolutionInfo( IN UINT tempwidth, IN UINT tempheight, IN VWSDK::PIXEL_FORMAT pixelFormat, IN UINT unPixelSize );
...
public:
	...
	VWSDK::HCAMERA			 m_lstCamera[DF_DEVICE_COUNT];
