...
namespace Vieworks
{
    ...
    */
    ...
    public class VwGigE   // GIGE
    {
        ...
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention=CallingConvention.Cdecl)]
        public static extern RESULT CameraSetExposureTime(HCAMERA hCamera, double fExptime_microsec);
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ConvertBGR8toBGR8(IntPtr pbSrc, int cbSrc, Byte[] pbDst);
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ConvertBAYGB10ToBGR10(IntPtr pbSrc, ushort[] pbDst, int width, int height);
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ConvertBAYGB12ToBGR12(IntPtr pbSrc, ushort[] pbDst, int width, int height);

        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ConvertBAYRG10ToBGR10(IntPtr pbSrc, ushort[] pbDst, int width, int height);
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ConvertBAYRG12ToBGR12(IntPtr pbSrc, ushort[] pbDst, int width, int height);

        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ConvertBAYGR10ToBGR10(IntPtr pbSrc, ushort[] pbDst, int width, int height);
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ConvertBAYGR12ToBGR12(IntPtr pbSrc, ushort[] pbDst, int width, int height);
