...
namespace Vieworks
{
    ...
    public class VwGigE   // GIGE
    {
        ...
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention=CallingConvention.Cdecl)]
        public static extern RESULT CloseVwGigE(ref VWGIGE_HANDLE hVwGigE);
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT IPAddressToIPDecimal(VWGIGE_HANDLE hVwGigE, IntPtr pIPAddress, int nSize, IntPtr pIPDeciaml);
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT IPDecimalToIPAddress(VWGIGE_HANDLE hVwGigE, int nIPDecimal, IntPtr pIPAddress, IntPtr pArgSize);
        ...
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwSetGVCPTimeout(VWGIGE_HANDLE hVwGigE, uint uTimeout);
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwGetGVCPTimeout(VWGIGE_HANDLE hVwGigE, ref uint uTimeout);
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwSetIgnoreSubnet(VWGIGE_HANDLE hVwGigE, bool bUse);
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwGetIgnoreSubnet(VWGIGE_HANDLE hVwGigE, ref bool bUse);
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwSetDiscoveryTimeout(VWGIGE_HANDLE hVwGigE, uint uTimeout);
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwGetDiscoveryTimeout(VWGIGE_HANDLE hVwGigE, ref uint uTimeout);
        ...
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention=CallingConvention.Cdecl)]
        public static extern RESULT InterfaceGetIPAddress(HINTERFACE hInterface, IntPtr pInterfaceName, IntPtr pIP, IntPtr aIP);
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT CameraGetGrabData(HCAMERA hCamera, ref IMAGE_INFO pImageInfo);
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention=CallingConvention.Cdecl)]
        public static extern RESULT CameraGetCustomCommand(HCAMERA hCamera, Byte[] pCommand, Byte[] pArg, IntPtr pArgSize, int nCmdType = (int)Vieworks.GET_CUSTOM_COMMAND.GET_CUSTOM_COMMAND_VALUE);
        [DllImport("VwGigE.NET.V7.DLL", CallingConvention=CallingConvention.Cdecl)]
