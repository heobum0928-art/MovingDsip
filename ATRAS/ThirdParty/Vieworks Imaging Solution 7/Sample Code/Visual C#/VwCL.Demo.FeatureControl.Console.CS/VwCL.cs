...
namespace Vieworks
{
    ...
    public enum     PIXEL_FORMAT
    {
        ...
        IXEL_FORMAT_MONO12_P = 0x010C0047,
    ...
    {
        public PROPERTY_TYPE ePropType;
        public PROPERTY_ACCESS_MODE eAccessMode;
        public PROPERTY_VISIBILITY eVisibility;
        public PROPERTY_REPRESENTATION eRepresentation;
        uint unPollingTime;
        //[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 256)]
    ...
    public class VwCL   // Camera Link
    {
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT OpenVwCL(ref VWCL_HANDLE hVwCL);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT CloseVwCL(ref VWCL_HANDLE hVwCL);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwGetNumInterfaces(VWCL_HANDLE hVwCL, IntPtr pNumInterfaces);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwGetNumCameras(VWCL_HANDLE hVwCL, ref int aPNumCamera);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwOpenCameraByIndex(VWCL_HANDLE hVwCL, int nCameraIndex, ref HCAMERA phCamera, int nNumBuffer, int nWidth, int nHeight,
        ...
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwOpenCameraByName(VWCL_HANDLE hVwCL, IntPtr pCameraName, ref HCAMERA phCamera, int nNumBuffer, int nWidth,
                                                        int nHeight, int nPacketSize, IntPtr pUserPointer, IntPtr pImageCallbackFn, IntPtr pDisconnectCallbackFn);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwOpenInterfaceByIndex(VWCL_HANDLE hVwCL, int aNIndex, ref HINTERFACE phInterface);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwOpenInterfaceByName(VWCL_HANDLE hVwCL, IntPtr pInterfaceName, ref HINTERFACE phInterface);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwDiscovery(VWCL_HANDLE hVwCL);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwDiscoveryInterfaceInfo(VWCL_HANDLE hVwCL, int nIndex, ref INTERFACE_INFO_STRUCT pInterfaceInfoStruct);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwDiscoveryCameraInfo(VWCL_HANDLE hVwCL, int nIndex, ref CAMERA_INFO_STRUCT pCameraInfoStruct);  
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwSetDiscoveryTimeout(VWCL_HANDLE hVwCL, uint uTimeout);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT VwGetDiscoveryTimeout(VWCL_HANDLE hVwCL, ref uint uTimeout);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT InterfaceGetVwCLHandle(HINTERFACE hInterface, IntPtr phVwCLHandle);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT CameraSetCustomCommand(HCAMERA hCamera, char[] pCommand, char[] pArg);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT CameraGetCustomCommand(HCAMERA hCamera, char[] pCommand, Byte[] pArg, ref int pArgSize, int nCmdType);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT CameraGetPropertyCount(HCAMERA hCamera, ref int pCount);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT CameraGetPropertyInfo(HCAMERA hCamera, char[] pCommand, ref PROPERTY ptPropInfo);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT CameraGetPropertyInfoUsingIndex(HCAMERA hCamera, int nIndex, ref PROPERTY ptPropInfo);
        [DllImport("VwCL.NET.DLL", CallingConvention = CallingConvention.Cdecl)]
        public static extern RESULT CameraGetDeviceHandle(HCAMERA hCamera, ref HDEVICE pDevice);
    }
}
