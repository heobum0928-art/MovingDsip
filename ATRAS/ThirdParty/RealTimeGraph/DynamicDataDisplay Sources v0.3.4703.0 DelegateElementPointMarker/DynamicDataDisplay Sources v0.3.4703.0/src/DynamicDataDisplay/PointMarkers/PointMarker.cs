...
{
	public delegate void MarkerRenderHandler(DrawingContext dc, object dataPoint, Point screenPoint);
	...
	public abstract class PointMarker : DependencyObject {
		...
		public abstract void Render(DrawingContext dc, object dataPoint, Point screenPoint);
